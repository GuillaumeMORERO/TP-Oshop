<section class="hero">
    <div class="container">
      ...
      <ol class="breadcrumb justify-content-center">
        ...
        <li class="breadcrumb-item active">TODO nom du Type de produits</li>
      </ol>
      <!-- Hero Content-->
      <div class="hero-content pb-5 text-center">
        <h1 class="hero-heading">TODO Type n°<?= $viewVars['id'] ?></h1>
        <div class="row">
      ...
      <div class="row">
        ...
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          <div class="product-image">
            <a href="<?= $router->generate('produit', ['id'=>24 /* TODO rendre dynamique */ ]) ?>" class="product-hover-overlay-link">
              <img src="<?= $absoluteURL ?>/assets/images/produits/1-kiss_tn.jpg" alt="product" class="img-fluid">
            </a>
          </div>
          <div class="product-action-buttons">
            <a href="#" class="btn btn-outline-dark btn-product-left"><i class="fa fa-shopping-cart"></i></a>
            <a href="<?= $router->generate('produit', ['id'=>24 /* TODO rendre dynamique */ ]) ?>" class="btn btn-dark btn-buy"><i class="fa-search fa"></i><span class="btn-buy-label ml-2">Voir</span></a>
          </div>
          <div class="py-2">
            <p class="text-muted text-sm mb-1">Chausson</p>
            <h3 class="h6 text-uppercase mb-1"><a href="<?= $router->generate('produit', ['id'=>24 /* TODO rendre dynamique */ ]) ?>" class="text-dark">Kissing</a></h3><span class="text-muted">40€</span>
          </div>
        </div>
        <!-- /product-->
        <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              ...
              <h3 class="h6 text-uppercase mb-1"><a href="<?= $router->generate('produit', ['id'=>24 /* TODO rendre dynamique */ ]) ?>" class="text-dark">Pink lady</a></h3><span class="text-muted">20€</span>
            </div>
          </div>
          <!-- /product-->
          <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              <p class="text-muted text-sm mb-1">Chausson</p>
              <h3 class="h6 text-uppercase mb-1"><a href="<?= $router->generate('produit', ['id'=>24 /* TODO rendre dynamique */ ]) ?>" class="text-dark">Panda</a></h3><span class="text-muted">50€</span>
            </div>
          </div>
          <!-- /product-->
          <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              ...
              <h3 class="h6 text-uppercase mb-1"><a href="<?= $router->generate('produit', ['id'=>24 /* TODO rendre dynamique */ ]) ?>" class="text-dark">Deadpool</a></h3><span class="text-muted">15€</span>
            </div>
          </div>
          <!-- /product-->
