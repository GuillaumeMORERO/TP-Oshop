        ...
        <div class="row d-flex align-items-center">
          ...
          <div class="col-sm-5 d-flex justify-content-end">
            ...
            <div class="dropdown pl-3 ml-0">
              <a id="currencyDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle topbar-link"><?= $currentCurrency ?></a>
              <div aria-labelledby="currencyDropdown" class="dropdown-menu dropdown-menu-right">
                <?php if ($currentCurrency != 'EUR') : ?>
                <a href="<?= $router->generate('currency-change', ['isoCode'=>'EUR']) ?>" class="dropdown-item text-sm">EUR</a>
                <?php endif ?>
                <?php if ($currentCurrency != 'USD') : ?>
                <a href="<?= $router->generate('currency-change', ['isoCode'=>'USD']) ?>" class="dropdown-item text-sm">USD</a>
                <?php endif ?>
                <?php if ($currentCurrency != 'GBP') : ?>
                <a href="<?= $router->generate('currency-change', ['isoCode'=>'GBP']) ?>" class="dropdown-item text-sm">GBP</a>
                <?php endif ?>
              </div>
            </div>
          </div>
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          <div class="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
            ...
            <div class="nav-item dropdown">
              <a href="<?= $router->generate('mon-panier') ?>" class="navbar-icon-link d-lg-none">
                  <span class="badge badge-secondary">New</span>
              </a>
              <div class="d-none d-lg-block">
                <a id="cartdetails" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false" href="<?= $router->generate('mon-panier') ?>" class="navbar-icon-link dropdown-toggle">
                  ...
                  <div class="navbar-cart-product-wrapper">
                    ...
                    <div class="navbar-cart-product">
                      ...
                      <div class="w-100">
                          ...
                          <div> <a href="<?= $router->generate('produit', ['id'=>24 /* TODO rendre dynamique */ ]) ?>" class="navbar-cart-product-link">Retro socks</a><small
                    ...
                    <div class="navbar-cart-product">
                      ...
                      <div class="w-100">
                          ...
                          <div> <a href="<?= $router->generate('produit', ['id'=>24 /* TODO rendre dynamique */ ]) ?>" class="navbar-cart-product-link">Dillinger</a><small
                    ...
                    <div class="d-flex justify-content-between">
                      <a href="<?= $router->generate('mon-panier') ?>" class="btn btn-link text-dark mr-3">Voir le panier <i class="fa-arrow-right fa"></i></a>
