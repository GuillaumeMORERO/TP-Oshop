        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <li> <a href="<?= $router->generate('type', ['id'=>42 /* TODO dynamiser */]) ?>" class="text-muted">Chaussures de ville</a></li>
              <li> <a href="<?= $router->generate('type', ['id'=>42 /* TODO dynamiser */]) ?>" class="text-muted">Chaussures de sport</a></li>
              <li> <a href="<?= $router->generate('type', ['id'=>42 /* TODO dynamiser */]) ?>" class="text-muted">Pantoufles</a></li>
              <li> <a href="<?= $router->generate('type', ['id'=>42 /* TODO dynamiser */]) ?>" class="text-muted">Tongs</a></li>
              <li> <a href="<?= $router->generate('type', ['id'=>42 /* TODO dynamiser */]) ?>" class="text-muted">Chaussons</a></li>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            <h6 class="text-uppercase text-dark mb-3">Marques</h6>
            <ul class="list-unstyled">
              <li> <a href="<?= $router->generate('marque', ['id'=>26 /* TODO dynamiser */]) ?>" class="text-muted">oCirage</a></li>
              <li> <a href="<?= $router->generate('marque', ['id'=>26 /* TODO dynamiser */]) ?>" class="text-muted">Shossures</a></li>
              <li> <a href="<?= $router->generate('marque', ['id'=>26 /* TODO dynamiser */]) ?>" class="text-muted">BOOTstrap</a></li>
              <li> <a href="<?= $router->generate('marque', ['id'=>26 /* TODO dynamiser */]) ?>" class="text-muted">Talonette</a></li>
              <li> <a href="<?= $router->generate('marque', ['id'=>26 /* TODO dynamiser */]) ?>" class="text-muted">oPompes</a></li>
            </ul>
          </div>
          <div class="col-lg-4">
